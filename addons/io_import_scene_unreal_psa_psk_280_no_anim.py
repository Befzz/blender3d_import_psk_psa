...
bl_info = {
    "name": "Import Unreal Skeleton Mesh (.psk) (280) (no_anim)",
...
def pskimport(filepath, bImportmesh = True, bImportbone = True, bDebugLogPSK = False, bImportsingleuv = False, bonesize = 3.0, bonesize_auto = True):
